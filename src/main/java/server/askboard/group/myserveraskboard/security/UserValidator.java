...
public class UserValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "username", "Not between 6 and 32");
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "password", "Not between 8 and 32");
